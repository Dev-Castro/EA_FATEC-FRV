def entrada_de_dados(arquivo):

    found = False

    # Tente abrir o arquivo e adicionar os valores a lista.
    try:
    ...
    # Se não encontrar o arquivo, verifica se o usuário quer continuar no programa ou sair.
        ...
        return found, resposta

def rolDeDados(valores):
...
|____________________________________________________________|
    ...
    # Quando todos os valores se repetem, porém em mesma frequência.
        ...
        # Print info moda.
        print("\nA classificação desse conjunto de dados é: \033[1;31m%s\033[m." % classe[indice])
        print("Quando todos os valores se repetem, porém em mesma frequência.")
